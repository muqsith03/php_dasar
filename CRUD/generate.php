<?php 
    ...
    if(!$hasil_query){
        ...
        echo "tabel <b>'mahasiswa'</b> berhasil dihapus...";
    }
    ...
    if(!$hasil_query){
        ...
        echo "table <b>'mahasiswa' berhasil diisii...</b>";
    }
